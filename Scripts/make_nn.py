...
builder = coremltools.models.neural_network.NeuralNetworkBuilder(spec=model._spec)

builder.make_updatable(["fullyconnected0"])

builder.set_categorical_cross_entropy_loss(name="lossLayer", input="labelProbability")
builder.set_adam_optimizer(AdamParams(lr=0.01, batch=16, beta1=0.9, beta2=0.999, eps=1e-8))
